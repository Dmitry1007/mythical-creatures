...
class UnicornTest < Minitest::Test
  ...
  def test_unicorn_has_default_weight
    unicorn = Unicorn.new("Maggie")
    assert_equal 500, unicorn.weight
  end

  def test_are_you_skinny? 
    unicorn = Unicorn.new("Peg")
    assert_equal true, unicorn.skinny?
  end
